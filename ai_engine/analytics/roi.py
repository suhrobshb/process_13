...
if __name__ == "__main__":
    ...
    print(f"\n📊 ROI Report for User ID: {demo_user_id}")
    print("-----------------------------------------")
    print(f"  ✅ Total Automations Run: {roi_results['automations_run']}")
    print(f"  📈 Success Rate: {roi_results['success_rate']}%")
    print(f"  ⏰ Total Hours Saved: {roi_results['hours_saved']} hours")
    print(f"  💰 Estimated Cost Saved: ${roi_results['cost_saved']:,.2f} (at ${AVERAGE_FTE_COST_PER_HOUR}/hr)")
    print("-----------------------------------------")
